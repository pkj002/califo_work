...
- USDA Cropland Data Layer datasets

All datasets were spatially aligned on a common WGS84 latitude–longitude grid
for climate-risk analyses and visualization.

## Citation

If you use this repository or associated datasets, please cite:
Jha, P. K. (2026). Datasets associated with "From intermittent to persistent chill insufficiency in California’s specialty crops". Zenodo. https://doi.org/10.5281/zenodo.20058559
